...
return [
    ...
    */
    ...
    'between'              => [
        'numeric' => 'El :attribute must be between :min y :max.',
        'file'    => 'El :attribute must be between :min y :max kilobytes.',
        'string'  => 'El :attribute must be between :min y :max characters.',
    ...
    'digits_between'       => 'El :attribute must be between :min y :max digits.',
    ...
    'min'                  => [
        ...
        'string'  => 'El :attribute al menos debe ser de :min caracteres.',
